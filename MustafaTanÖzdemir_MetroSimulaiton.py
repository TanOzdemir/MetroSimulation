...
class MetroAgi:
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        while pq:
            oncelik, _, mevcut_istasyon, mevcut_rota, mevcut_sure = heapq.heappop(pq)
            
            if mevcut_istasyon == hedef:
                return mevcut_rota, mevcut_sure
            ...
            for komsu, sure in mevcut_istasyon.komsular:
                if komsu not in ziyaret_edildi:
                    ...
                    heapq.heappush(pq, (yeni_sure, id(komsu), komsu, yeni_rota, yeni_sure))
        
        return None

# Main Test Senaryoları
